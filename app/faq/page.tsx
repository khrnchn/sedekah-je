...
const faqData = [
  {
    question: "Saya ada beberapa gambar kod QR yang diambil dari masjid. Bagaimanakah cara untuk saya menyumbang?",
    answer:
  ...
  },
  {
    ...
    answer: "Tidak, kami tidak mengambil sebarang yuran atau komisen. Kod QR yang disediakan adalah diambil terus dari masjid atau laman sosial mereka.",
  },
  {
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        Anda boleh melihat senarai <span className="italic">maintainer/contributor</span> di{" "}
        <Link
