...
interface DeleteInstitutionsDialogProps
  extends React.ComponentPropsWithoutRef<typeof Dialog> {
  institutions: Row<Institution>["original"][]
  showTrigger?: boolean
  onSuccess?: () => void
}

export function DeleteInstitutionsDialog({
  institutions,
  showTrigger = true,
  onSuccess,
  ...props
}: DeleteInstitutionsDialogProps) {
  ...
  function onDelete() {
    startDeleteTransition(async () => {
      ...
      toast.success("Institutions deleted")
      onSuccess?.()
    })
  }
