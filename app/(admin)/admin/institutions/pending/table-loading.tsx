...
const COLUMNS: Array<{ head: string; cell: string }> = [
	{ head: "h-4 w-4", cell: "h-4 w-4" },
	{ head: "h-4 w-6", cell: "h-4 w-8" },
	{ head: "h-4 w-8", cell: "h-10 w-10 rounded-md" },
	{ head: "h-4 w-12", cell: "h-4 w-40" },
	{ head: "h-4 w-16", cell: "h-5 w-24 rounded-full" },
	{ head: "h-4 w-16", cell: "h-5 w-16 rounded-md" },
	{ head: "h-4 w-10", cell: "h-4 w-20" },
	{ head: "h-4 w-8", cell: "h-4 w-20" },
	{ head: "h-4 w-20", cell: "h-4 w-24" },
	{ head: "h-4 w-16", cell: "h-4 w-24" },
	{ head: "h-4 w-4", cell: "h-8 w-16 rounded-md" },
];

export default function PendingTableLoading() {
	return (
