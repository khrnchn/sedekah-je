...
import { SJHeader } from "./sj-header";
...
const SJLayout = React.forwardRef<HTMLDivElement, LayoutProps>(
...
export { SJLayout, LayoutHeader, LayoutBody };
