...
export const institutions = pgTable("institutions", {
	...
	state: varchar("state", { length: 100 }).notNull().$type<typeof states[number]>(),
	...
	// Workflow fields
	status: varchar("status", { length: 20 }).default("pending").notNull().$type<typeof institutionStatuses[number]>(),
